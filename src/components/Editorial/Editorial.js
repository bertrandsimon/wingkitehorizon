...
export default function Editorial() {
  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 p-4 sm:p-6 lg:p-10 py-10 sm:py-12 lg:py-16 font-poppins">
      <div>
        <p className={`${textColor} text-sm leading-[1.92] font-light`}>
          {locale === "en"
            ...
            : locale === "es"
              ? '"Wing Kite Horizon es un crucero deportivo dedicado al kitesurf y al wingfoil, pensado para aprender o progresar con coaching privado mientras navegas por aguas griegas. A bordo de un catamarán, cada día alterna sesiones guiadas, navegación entre spots y tiempo libre. El formato ofrece una progresión real, condiciones variadas y una forma sencilla de combinar técnica, viaje y disfrute."'
      ...
      <div>
        <p className={`${textColor} text-sm leading-[1.92] font-light`}>
          {locale === "en"
            ...
            : locale === "es"
              ? '"Las herramientas pedagógicas, los briefings y el feedback en vídeo te ayudan a ajustar la técnica rápidamente y progresar con seguridad. El catamarán actúa como una base móvil, evitando traslados innecesarios y dando acceso a diferentes zonas con características distintas. El objetivo es simple: aprender más rápido, navegar más a menudo y volver con un nivel realmente superior."'
